...
# Default-Stop:      0 1 6
# Short-Description: Jetty webserver for JOC
# Description:       Jetty webserver for JOC
### END INIT INFO
...
JAVA_OPTIONS=(${JAVA_OPTIONS[*]} "-Djetty.home=$JETTY_HOME" "-Djetty.base=$JETTY_BASE" "-Djava.io.tmpdir=$TMPDIR" "-Dfile.encoding=UTF-8" "-Duser.timezone=UTC" "-Djava.util.prefs.userRoot=$JETTY_BASE")
